...
const appRout: Routes = [
  ...
  {
    path: "MyCreateTransportation",
    component: MyCreateTransportationComponent,
  },
  { path: "AllTransportation", component: MyCreateTransportationComponent },
  ...
  { path: "ShowDetails", component: ShowAndCalcComponent },
  { path: "CalcRoute", component: CalcRoutComponent },
  { path: "ShowCalcRoute", component: CalcRoutComponent },
...
@NgModule({
  declarations: [],
  imports: [CommonModule, RouterModule.forRoot(appRout)],
})
